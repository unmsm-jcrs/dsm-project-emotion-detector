...
import com.example.proyectodsm.utils.BitmapUtils.toGrayscale
import com.example.proyectodsm.utils.BitmapUtils.toGrayscaleByteBuffer
...
private const val MODEL_FILE_NAME = "tensorflow_model.tflite"
private const val LABELS_FILE_NAME = "emotions.names"
...
object AppModel {
    ...
    fun load(context: Context): Interpreter {
        if (!this::interpreter.isInitialized) {
            synchronized(AppModel::class.java) {
